...
class TestimonialAdmin(admin.ModelAdmin):
    search_fields = ('given_by__user__username', 'given_to__user__username', 'given_by__user__first_name', 'given_to__user__first_name', 'given_by__full_name', 'given_to__full_name')
...
class PollAnswerAdmin(admin.ModelAdmin):
    search_fields = ('voted_by__user__username', 'voted_by__user__first_name', 'voted_by__full_name', 'answer__user__username', 'answer__user__first_name', 'answer__full_name', 'question__question')
