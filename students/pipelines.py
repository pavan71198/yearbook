    ...
    if backend.name == 'azuread-tenant-oauth2':
        if Profile.objects.filter(user=user).count()==0:
            ...
            if  rollno.isnumeric():
                ...
                graduating = True
                if (year != 2016 and (program == "01" or program == "02")) or ( year!= 2017 and (program == "41" or program == "42" or program == "43" or program == "21" or program == "22")):
                    graduating = False
                ...
                Profile.objects.create(user=user, full_name=response['name'], department='00', program='00', rollno=000000000, graduating=False)
